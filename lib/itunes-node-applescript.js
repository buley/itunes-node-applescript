...
var scripts = {
    ...
    playlistArtists:
	'tell application "iTunes" to get artist of every track of playlist "%s"',
    playlistAlbums:
	'tell application "iTunes" to get album of every track of playlist "%s"',
    playlistGenres:
	'tell application "iTunes" to get genre of every track of playlist "%s"',
    artistTracks:
	'tell application "iTunes" to get name of every track of playlist "Library" where artist = "%s"',
    artistAlbums:
	'tell application "iTunes" to get album of every track of playlist "Library" where artist = "%s"',
    artistGenres:
	'tell application "iTunes" to get genre of every track of playlist "Library" where artist = "%s"',
    albumTracks:
	'tell application "iTunes" to get name of every track of playlist "Library" where album = "%s"',
    albumGenres:
	'tell application "iTunes" to get genre of every track of playlist "Library" where album = "%s"',
    albumArtists:
	'tell application "iTunes" to get artist of every track of playlist "Library" where album = "%s"',
    genreTracks:
	'tell application "iTunes" to get name of every track of playlist "Library" where genre = "%s"',
    genreArtists:
	'tell application "iTunes" to get artist of every track of playlist "Library" where genre = "%s"',
    genreAlbums:
	'tell application "iTunes" to get album of every track of playlist "Library" where genre = "%s"',
    playlistTrack:
...
exports.playlistArtists = function(playlist, callback){
    return execScript('playlistArtists', playlist, callback);
};
exports.playlistAlbums = function(playlist, callback){
    return execScript('playlistAlbums', playlist, callback);
};
exports.playlistGenres = function(playlist, callback){
    return execScript('playlistGenres', playlist, callback);
};

exports.artistTracks = function(playlist, artist, callback){
    return execScript('artistTracks', playlist, artist, callback);
};
exports.albumTracks = function(playlist, album, callback){
    return execScript('albumTracks', playlist, album, callback);
};
exports.genreTracks = function(playlist, genre, callback){
    return execScript('genreTracks', playlist, genre, callback);
};

exports.artistAlbums = function(playlist, artist, callback){
    return execScript('artistAlbums', playlist, artist, callback);
};
exports.genreAlbums = function(playlist, genre, callback){
    return execScript('genreAlbums', playlist, genre, callback);
};

exports.albumArtists = function(playlist, artist, callback){
    return execScript('albumArtists', playlist, artist, callback);
};
exports.genreArtists = function(playlist, genre, callback){
    return execScript('genreArtists', playlist, genre, callback);
};

exports.artistGenres = function(playlist, artist, callback){
    return execScript('artistGenres', playlist, artist, callback);
};
exports.albumGenres = function(playlist, genre, callback){
    return execScript('albumGenres', playlist, genre, callback);
};

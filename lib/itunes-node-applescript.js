...
var scripts = {
    ...
    playArtist:
        'tell application "iTunes" to set search_results to (search library playlist 1 for "%s" only artists)', 
    playTrack:
...
exports.playPlaylist = function(track, callback){
    return execScript('playPlaylist', track, callback);
};

exports.playArtist = function(track, callback){
    return execScript('playTrack', track, callback);
};

exports.playRadio = function(track, callback){
    return execScript('playRadio', track, callback);
};

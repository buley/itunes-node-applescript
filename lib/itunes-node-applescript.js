...
var scripts = {
    ...
    artistTracks:
	'tell application "iTunes" to get index of every track of playlist "Library" where artist = "%s"',
    albumTracks:
	'tell application "iTunes" to get index of every track of playlist "Library" where album = "%s"',
    genreTracks:
	'tell application "iTunes" to get index of every track of playlist "Library" where genre = "%s"',
    artistTrackIds:
	'tell application "iTunes" to get id of every track of playlist "Library" where artist = "%s"',
    albumTrackIds:
	'tell application "iTunes" to get id of every track of playlist "Library" where album = "%s"',
    genreTrackIds:
	'tell application "iTunes" to get id of every track of playlist "Library" where genre = "%s"',
    playlistTrack:
